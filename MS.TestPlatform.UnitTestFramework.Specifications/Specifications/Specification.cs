...
namespace MS.TestPlatform.UnitTestFramework.Specifications
{
	public class Specification
	{
        ...
        private string GetSpecificationDescription()
        {
            ...
            var attributes = specificationType.GetTypeCustomAttributes(typeof(SpecificationDescriptionAttribute), false).ToArray();
	    ...
	    private string GetScenarioDescription()
	    {
	        ...
	        var attributes = testMethod.GetMemberCustomAttributes(typeof(ScenarioDescriptionAttribute), false).ToArray();
        ...
        private string BuildReport()
        {
            ...
            for (var grammarIndex = 0; grammarIndex < Context.Grammars.Count; grammarIndex++)
            {
            ...
            for (var exceptionIndex = 0; exceptionIndex < exceptions.Count; exceptionIndex++)
            {
